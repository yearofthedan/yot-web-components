...
function c(t, e) {
  ...
  for (; n.nextNode(); ) {
    ...
    for (
      ...
      (o.index = null !== c ? -1 : o.index - l), (r = p(i, r)), (o = i[r]);
  }
...
class b {
  ...
  _getValue() {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (v(t) || !w(t)) s += 'string' == typeof t ? t : String(t);
...
const V = t =>
  t &&
  (T ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
function k(t) {
  let e = U.get(t.type);
  void 0 === e &&
...
const M = new (class {
  handleAttributeExpressions(t, e, s, i) {
    ...
    if ('@' === n) return [new E(t, e.slice(1), i.eventContext)];
    if ('?' === n) return [new N(t, e.slice(1), s)];
    return new b(t, e, s).parts;
  }
    ...
    s
      ? (function (t, e, s = null) {
          ...
          for (; r.nextNode(); ) {
            ...
            for (
              r.currentNode === s &&
              ((a = d(e)), s.parentNode.insertBefore(e, s));
              -1 !== o && n[o].index === l;
...
const I = {
  ...
  B = (t, e) => e !== t && (e == e || t == t),
  H = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: B };
  ...
  (tt.render = (t, s, i) => {
    ...
    if (
      (((t, s, i) => {
        ...
        void 0 === n &&
          (e(s, s.firstChild),
          O.set(s, (n = new P(Object.assign({ templateFactory: k }, i)))),
          n.appendInto(s)),
          n.setValue(t),
          n.commit();
      })(t, l, Object.assign({ templateFactory: q(n) }, i)),
      a)
    ) {
      const t = O.get(l);
      O.delete(l);
      const i = t.value instanceof y ? t.value.template : void 0;
      L(n, l, i), e(s, s.firstChild), s.appendChild(l), O.set(s, t);
    }
    !r && o && window.ShadyCSS.styleElement(s.host);
  });
export { tt as L, D as a, Y as c, R as h, G as p };
